...
<div class="col-lg-9">
	...
	<label>Client GST No</label>
		<input type="text" class="form-control" name="txt_gstno" id="txt_gstno" value="<?php if(isset($_GET["id"])){ echo $data['cust_gst_no'];} else {}?>" placeholder="Client GST No">
	</div>
	...
	<div class="col-md-6">
		...
		<label>Client Email</label>
			<input type="text" class="form-control" name="txt_scemail" id="txt_scemail" value="<?php if(isset($_GET["id"])){ echo $data['ship_email'];} else {}?>"  placeholder="Client Email ">
		</div>
...
?>
<div class="col-md-6">
	<textarea class="form-control" name="txt_terms" id="txt_terms" rows="4" placeholder="Terms" style="border: none;"><?php if(isset($_GET["id"])){ echo $data['terms'];} else {}?></textarea>
</div>
<div class="panel-body"></div>

<h4>Bank Details</h4>
<div class="col-md-6">
	<textarea class="form-control" rows="4" name="txt_bank" id="txt_bank" placeholder="Company Bank Details." style="border: none;"><?php if(isset($_GET["id"])){ echo $data['bank_details'];} else {}?></textarea>
</div>
<div class="panel-body"></div>
...
<!-- <h4>Tags</h4>
	...
	<div id="err_msg"></div>
	<button name="product_submit" type="submit" class="btn btn-primary" name="print_button" id="print_button1" value="Print" onclick="PrintDiv1();"><span class="glyphicon glyphicon-print"></span>&nbsp;Challan</button>
	...
	?>
        <?php   require_once 'print_challan.php' ?>
	</div>
