            ...
            <!---------------------------------------->
               ...
               ?>
                ...
                <div class="outter-block">
                    ...
                    <div class="div-cont1" style="width:35%; font-size:12px;  border: 1px solid #dddddd; float: right; margin: 0px;">
                            ...
                            ?>
                                ...
                                <tr>   
                                    ...
                                    <td><?php echo $arr['Total_tax'];?></td>
                                </tr>
                                <tr>
                                    <td><b>Payable Amount (Rs.)</b></td>     
                                    <td><?php echo round($arr['Total_price']);?></td>
                                </tr>
                                <?php } ?>
                            </table>
                        </div>
