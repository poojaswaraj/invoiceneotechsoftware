...
<!-- <h4>Tags</h4>
	...
	<!-- <button name="product_submit" type="submit" class="btn btn-primary"  data-toggle="modal" data-target="#delInvoice" onclick="$('#dele_id').val('<?php echo $id;?>');">Delete</button>
	  ...
	  if(document.pressed == 'save')
	  	{
		    ...
		    if (aatpos<1 || adotpos<aatpos+2 || adotpos+2>=y.length) {
	         ...
	         $.ajax({
						data:$("#myform").serialize(),
						type:"POST",
						url:'insert_converted_invoice.php?cu_id=<?php echo $id; ?>&cust_id=<?php echo $cust_id; ?>',
						success: function(data)
						{
							...
							if(data==1)
							{
								 ...
								 swal({
								  ...
								  window.setTimeout(function()
								    { 
								    window.location.href= "user_dashboard.php?page=invoices";
								 	} ,1500);
