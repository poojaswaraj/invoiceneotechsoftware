               ...
               ?>
                ...
                <div class="outter-block">
                    <div class="div-left" style="width:49%;">
                        <div class="block2">
                            Invoice No: <b><?php echo $data['number']; ?></b>
                        </div>
                        <div class="block2">
                ...
                <div class="outter-block">
                    <div class="div-left1 div-cont" style="text-align:left; padding:2% 1%; width:98%; border-bottom:0 solid transparent; " >
                        <b>Bank Details</b><br>
                         <textarea rows="4" cols="96" style="border: none; font-family: serif; font-size: 15px;" ><?php echo $res['bank_details'];?></textarea>
                ...
                <div class="outter-block">
                    ...
                    <div class="div-right">
                        ...
                        <div class="block2" style="font-size:18px; text-align: center;"><b>For E-Business Canvas</b></div>
