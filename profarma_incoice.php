...
<div class="col-lg-9">
	...
	<div class="col-md-6">
		...
		<label>Client Email<span class="required_field">*</span></label>
			<input type="text" class="form-control" name="txt_cemail" id="txt_cemail" value="<?php if(isset($_GET["id"])){ echo $data['customer_email'];} else {}?>" placeholder="Client Email" required="">
		</div>
	  ...
	  if(document.pressed == 'save')
	  	{
		    ...
		    if (aatpos<1 || adotpos<aatpos+2 || adotpos+2>=y.length) {
	         ...
	         $.ajax({
						data:$("#myform").serialize(),
						type:"POST",
						url:'insert_profarma.php?cu_id=<?php echo $id; ?>&cust_id=<?php echo $cust_id; ?>',
						success: function(data)
						{
