...
<div class="row">
<h3>Edit Invoice&nbsp;-&nbsp;<?php echo $data['number']; ?></h3><hr>
...
<div class="col-lg-9">
	<div class="col-md-6">
		<input type="text" class="form-control" name="txt_cname" id="txt_cname" value="<?php if(isset($_GET["id"])){ echo $data['customer_name'];} else {}?>" placeholder="Client Name" style="text-transform:capitalize;" onkeyup="cust();" required="">

	</div>
	<div class="col-md-3">
		<input type="text" class="form-control" name="txt_cleagal_id" id="txt_cleagal_id" value="<?php if(isset($_GET["id"])){ echo $data['customer_identification'];} else {}?>" placeholder="Client Leagal Id">
	</div>
	<div class="col-md-3">
		<input type="text" class="form-control" name="txt_gstno" id="txt_gstno" value="<?php if(isset($_GET["id"])){ echo $data['cust_gst_no'];} else {}?>" placeholder="Client GST Number">
	</div>
	...
	<div class="col-md-6">
		...
		<div class="col-md-6">
			<input type="text" class="form-control" name="txt_cperson" id="txt_cperson" value="<?php if(isset($_GET["id"])){ echo $data['contact_person'];} else {}?>" placeholder="Contact Person" required="">
		</div>

		<div class="col-md-6">
			<input type="text" class="form-control" name="txt_cemail" id="txt_cemail" value="<?php if(isset($_GET["id"])){ echo $data['customer_email'];} else {}?>" placeholder="Client Email Address" required="">
		</div>

		<div class="panel-body"></div>

		<div class="col-md-6">
			<input type="text" class="form-control" name="txt_state" id="txt_state" value="<?php if(isset($_GET["id"])){ echo $data['invoice_state'];} else {}?>" placeholder="State" required="">
		</div>

		<div class="col-md-6">
			<input type="text" class="form-control" name="txt_code" id="txt_code" value="<?php if(isset($_GET["id"])){ echo $data['in_state_code'];} else {}?>" placeholder="State Code" readonly="">
		</div>
	...
	<div class="col-md-6">
		...
		<div class="col-md-6">
			<input type="text" class="form-control" name="txt_scperson" id="txt_scperson" value="<?php if(isset($_GET["id"])){ echo $data['ship_cont_person'];} else {}?>" placeholder="Contact Person">
		</div>

		<div class="col-md-6">
			<input type="text" class="form-control" name="txt_scemail" id="txt_scemail" value="<?php if(isset($_GET["id"])){ echo $data['ship_email'];} else {}?>"  placeholder="Client Email Address">
		</div>

		<div class="panel-body"></div>

		<div class="col-md-6">
			<input type="text" class="form-control" name="txt_sstate" id="txt_sstate" value="<?php if(isset($_GET["id"])){ echo $data['ship_state'];} else {}?>"  placeholder="State">
		</div>

		<div class="col-md-6">
			<input type="text" class="form-control" name="txt_scode" id="txt_scode" value="<?php if(isset($_GET["id"])){ echo $data['ship_state_code'];} else {}?>" placeholder="State Code">
		</div>
	...
	<div class="col-md-6">
		<textarea class="form-control" name="txt_iaddr" id="txt_iaddr" placeholder="Invoice Address" required=""><?php if(isset($_GET["id"])){ echo $data['invoicing_address'];} else {}?></textarea>
	</div>
	<div class="col-md-6">
		<textarea class="form-control" name="txt_saddr" id="txt_saddr" placeholder="Shipping Address"><?php if(isset($_GET["id"])){ echo $data['shipping_address'];} else {}?></textarea>
...
<div class="col-lg-3">
	...
	<div class="col-md-12">
		<input type="text" class="form-control" name="po_no" id="po_no" value="<?php if(isset($_GET["id"])){ echo $data['po_no'];} else {}?>" placeholder="PO/WO No">
	</div>
	<div class="panel-body"></div>

	<div class="col-md-12">
	<input type="date" class="form-control" name="po_date" id="po_date" value="<?php if(isset($_GET["id"])){ echo $data['po_date'];} else {}?>" placeholder="PO Date">
	</div>
	<div class="panel-body"></div>

	<div class="col-md-12">
		<input type="text" class="form-control" name="proj_name" id="proj_name" value="<?php if(isset($_GET["id"])){ echo $data['po_project_name'];} else {}?>" placeholder="Project Name">
	</div>
</div>
<div class="panel-body"></div>
...
<div class="col-lg-12">
	...
	<div class="col-md-3">
		...
		<select class="form-control" name="select_series" id="select_series">
		<?php
	...
	<div class="col-md-3">
		<input type="date" class="form-control" name="idate" id="idate" value="<?php if(isset($_GET["id"])){ echo $data['issue_date'];} else {}?>" required="">
	</div>
	<div class="col-md-1">
		<label>Due Date</label>
	</div>
	<div class="col-md-3">
		<input type="date" class="form-control" name="ddate" id="ddate" value="<?php if(isset($_GET["id"])){ echo $data['due_date'];} else {}?>">
	</div>
</div>
<div class="panel-body"></div>
...
<input type="hidden" name="aa" id="aa" value="<?php echo $id;?>">
  ...
  <div class="panel panel-default">
    <div style="height: 200px; overflow-y: scroll; overflow-x: hidden;">
	  ...
	  <?php
	  	...
	  	$sq = mysql_query("SELECT b.reference,a.* FROM `item` a INNER JOIN `product` b ON a.product_id=b.id LEFT JOIN common c ON c.id=a.common_id WHERE  a.common_id='$id' and a.status=1")or die(mysql_error($connection));
...
<?php
	$sum = mysql_query("SELECT SUM(unitary_cost * quantity) AS base, SUM(disc_amt) as 'Total_dis', SUM(tax_amt) as 'Total_tax', SUM(a.price) as 'Total_price' FROM item a INNER JOIN product b ON a.product_id=b.id INNER JOIN common c ON c.id=a.common_id WHERE  a.common_id='$id' and a.status=1 ")or die(mysql_error($connection));
...
?>
	...
	<div class="col-md-2">
		<input type="text" class="form-control" name="txt_base" id="txt_base" value="<?php echo $arr['base'];?>" placeholder="Base" readonly>
	</div>
	<div class="panel-body" ></div>
	<div class="col-md-9"></div>
	<div class="col-md-1">
	...
	<div class="col-md-2">
		<input type="text" class="form-control" name="txt_total_discount" id="txt_total_discount" value="<?php echo $arr['Total_dis'];?>" placeholder="Discount" readonly>
	</div>
	<div class="panel-body"></div>
	<div class="col-md-9"></div>
	<div class="col-md-1">
	...
	<div class="col-md-2">
		<input type="text" class="form-control" name="txt_subtotal" id="txt_subtotal" value="<?php echo $Subtotal;?>"  placeholder="Subtotal" readonly>
	</div>
	<div class="panel-body"></div>
	<div class="col-md-9"></div>
	<div class="col-md-1">
	...
	<div class="col-md-2">
		<input type="text" class="form-control" name="txt_total" id="txt_total" value="<?php echo $txt_total;?>" placeholder="Total" readonly>
...
?>
<div class="col-md-6">
	<textarea class="form-control" name="txt_terms" id="txt_terms" rows="4" placeholder="Terms" style="border: none;" readonly=""><?php if(isset($_GET["id"])){ echo $data['terms'];} else {}?></textarea>
</div>
<div class="panel-body"></div>

<h4>Bank Details</h4>
<div class="col-md-6">
	<textarea class="form-control" rows="4" name="txt_bank" id="txt_bank" placeholder="Company Bank Details." style="border: none;" readonly=""><?php if(isset($_GET["id"])){ echo $data['bank_details'];} else {}?></textarea>
</div>
<div class="panel-body"></div>
...
<!-- <h4>Tags</h4>
	...
	<button type="submit" class="btn btn-primary" data-toggle="modal" data-target="#printtemp" name="print_button" id="print_button" value="Print"><span class="glyphicon glyphicon-print"></span>&nbsp;Print</button>
	...
	<?php 
		if (isset($_POST['submit1'])) {
	    	 ...
	    	 require_once"print_invoice1.php";
	    } 
	?>
	</div>
...
<!--Print model start here-->

<div id="printtemp" class="modal fade" role="dialog">
	<div class="modal-dialog" style="width: 750px;">
		...
		<div class="modal-content">
		  	<div class="modal-header">
			    ...
			    <h4 class="modal-title" align="center">Print Invoice Templates</h4>
		  	</div>
			   <form autocomplete="off" enctype="multipart/formdata" method="POST">
				    <div class="modal-body">
		               <div class="form-group">
		                    <img src="images/print2.jpg"  style="height:500px;width:350px; float: left;" alt="logo">
		      				<img src="images/print1.jpg" style="height:500px;width:350px; float: left;" alt="logo">
		               </div>
		                <button class="btn btn-primary submit" style="float: left; margin: -65px 125px;" id="print1" name="submit1" onclick="PrintDiv();">Print First</button>
		                <button class="btn btn-primary submit" style="float: right; margin: -65px 125px;" id="print2" name="submit" onclick="PrintDivofsec();">Print Second</button>
				    </div>
			        <div class="modal-footer" style="padding: 15px;text-align: right;border-top: 0px solid #e5e5e5;">
		              <!--  <button class="btn btn-success submit" style="float: left;" id="print1" name="submit1" onclick="PrintDiv();">Print First</button>
		                <button class="btn btn-success submit" id="print2" name="submit" onclick="PrintDivofsec();">Print Second</button> -->
								...
								// $('#msg').css('color','green');
								 ...
								 swal({
								  ...
								  window.setTimeout(function()
								    { 
								     window.location.href= "user_dashboard.php?page=edit_new_invoice&id=<?php echo $id;?>";
								 	} ,1500);
