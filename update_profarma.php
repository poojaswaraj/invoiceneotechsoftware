...
$sql1 = mysql_query("UPDATE customer SET `user_id`='$sub_id',`sub_user_id`='$user_id',`name`='$txt_cname',`name_slug`='$string',`identification`='$txt_cleagal_id',`contact_person`='$txt_cperson',`email`='$txt_cemail',`invoicing_address`='$txt_iaddr',`shipping_address`='$txt_saddr',`gst_no`='$txt_gstno',`invoice_state`='$txt_state',`in_state_code`='$txt_code',`ship_cont_person`='$txt_scperson',`ship_email`='$txt_scemail',`ship_state`='$txt_sstate',`ship_state_code`='$txt_scode' WHERE id='$data'")or die(mysql_error($connection));
	...
	if($sql1==true)
	{
	   ...
	   $sql4 = mysql_query("UPDATE common SET `user_id`='$sub_id',`sub_user_id`='$user_id',`series_id`='$select_series',`customer_name`='$txt_cname',`customer_identification`='$txt_cleagal_id',`customer_email`='$txt_cemail',`invoicing_address`='$txt_iaddr',`shipping_address`='$txt_saddr',`contact_person`='$txt_cperson',`cust_gst_no`='$txt_gstno',`terms`='$txt_terms',`bank_details`='$txt_bank',`notes`='$txt_notes',`base_amount`='$txt_base',`discount_amount`='$txt_total_discount',`net_amount`='$txt_subtotal',`tax_amount`='$txt_total_tax',`gross_amount`='$txt_total',`amt_words`='$test',`due_amt`='$txt_total',`status`='Pending',`type`='Profarma-Invoice',`issue_date`='$idate',`due_date`='$ddate',`updated_at`='$dt',`invoice_state`='$txt_state',`in_state_code`='$txt_code',`ship_cont_person`='$txt_scperson',`ship_email`='$txt_scemail',`ship_state`='$txt_sstate',`ship_state_code`='$txt_scode',`po_no`='$po_no',`po_date`='$po_date',`po_project_name`='$proj_name' WHERE id='$data'")or die(mysql_error($connection));
	...
	if($sql1==true)
	{
			...
			function convertNumber($txt_total)
				...
				function convertDigit($digit)
				{
				 ...
				 $num = $txt_total;
				 $test = convertNumber($num);
	   $sql4 = mysql_query("UPDATE common SET `user_id`='$user_id',`sub_user_id`='$sub_id',`series_id`='$select_series',`customer_name`='$txt_cname',`customer_identification`='$txt_cleagal_id',`customer_email`='$txt_cemail',`invoicing_address`='$txt_iaddr',`shipping_address`='$txt_saddr',`contact_person`='$txt_cperson',`cust_gst_no`='$txt_gstno',`terms`='$txt_terms',`bank_details`='$txt_bank',`notes`='$txt_notes',`base_amount`='$txt_base',`discount_amount`='$txt_total_discount',`net_amount`='$txt_subtotal',`tax_amount`='$txt_total_tax',`gross_amount`='$txt_total',`amt_words`='$test',`due_amt`='$txt_total',`status`='Pending',`type`='Profarma-Invoice',`issue_date`='$idate',`due_date`='$ddate',`updated_at`='$dt',`invoice_state`='$txt_state',`in_state_code`='$txt_code',`ship_cont_person`='$txt_scperson',`ship_email`='$txt_scemail',`ship_state`='$txt_sstate',`ship_state_code`='$txt_scode',`po_no`='$po_no',`po_date`='$po_date',`po_project_name`='$proj_name' WHERE id='$data'")or die(mysql_error($connection));
