...
<div class="row">
<h3>Edit Recurring Invoice&nbsp;-&nbsp;<?php echo $data['number']; ?></h3><hr>

<h4>Invoice Execution Time </h4>
...
<div class="col-lg-12">
	...
	<div class="col-md-2">
		<input type="date" class="form-control" name="start_date" id="start_date"  value="<?php if(isset($_GET["id"])){ echo $data['starting_date'];} else {}?>" >
	</div>
	<div class="col-md-2">
		<label>Create Every</label>
	</div>
	<div class="col-md-1">
		<input type="text" class="form-control" name="duration" id="duration" placeholder="Duration" value="<?php if(isset($_GET["id"])){ echo $data['period'];} else {}?>">
	</div>
	<div class="col-md-1" >
		<select class="form-control" name="sel_duration" id="sel_duration">
			<option value="<?php if(isset($_GET["id"])){ echo $data['period'];} else {}?>"><?php echo $data['period_type'];  ?></option>
...
<div class="col-md-12">
	...
	<div class="col-md-2">
		<input type="date" class="form-control" name="finsh_date" id="finsh_date" value="<?php if(isset($_GET["id"])){ echo $data['finishing_date'];} else {}?>" >
	</div>
	<div class="col-md-3">
		<label>Maximum Number Of Occurrences:</label>
	</div>
	<div class="col-md-1">
		<input type="text" class="form-control" name="max_occur" id="max_occur" placeholder="Number"  value="<?php if(isset($_GET["id"])){ echo $data['max_occurrences'];} else {}?>">
	</div>
</div>
<div class="panel-body"></div>
...
<div class="col-lg-9">
	<div class="col-md-6">
		<input type="text" class="form-control" name="txt_cname" id="txt_cname" value="<?php if(isset($_GET["id"])){ echo ucwords($data['customer_name']);} else {}?>" placeholder="Client Name" style="text-transform:capitalize;" onkeyup="cust();" required="">
	...
	<div class="col-md-6">
		...
		<div class="col-md-6">
			<input type="text" class="form-control" name="txt_scode" id="txt_scode" value="<?php if(isset($_GET["id"])){ echo $data['ship_state_code'];} else {}?>" placeholder="State Code" onkeyup="state_ship();">
		</div>
	...
	<div class="col-md-6">
		<textarea class="form-control" name="txt_saddr" id="txt_saddr" placeholder="Shipping Address" required=""><?php if(isset($_GET["id"])){ echo $data['shipping_address'];} else {}?></textarea>
	...
	<!-- <div class="col-md-6">
		<input type="text" class="form-control" name="txt_cperson" id="txt_cperson" value="<?php if(isset($_GET["id"])){ echo $data['contact_person'];} else {}?>" placeholder="Contact Person">
	</div>
	<div class="col-md-6">
		<input type="text" class="form-control" name="txt_cemail" id="txt_cemail" value="<?php if(isset($_GET["id"])){ echo $data['customer_email'];} else {}?>" placeholder="Client Email Address">
	</div>
	<div class="panel-body"></div>
	<div class="col-md-6">
		<textarea class="form-control" name="txt_iaddr" id="txt_iaddr" placeholder="Invoice Address"><?php if(isset($_GET["id"])){ echo $data['invoicing_address'];} else {}?></textarea>
	</div>
	<div class="col-md-6">
...
<div class="col-lg-12">
	...
	<div class="col-md-3">
		<input type="date" class="form-control" name="idate" id="idate" value="<?php if(isset($_GET["id"])){ echo $data['issue_date'];} else {}?>" >
	</div>
	<div class="col-md-1">
...
<!-- <h4>Tags</h4>
	...
	<!-- <button name="product_submit" type="submit" class="btn btn-primary">Delete</button>
	<button name="product_submit" type="submit" class="btn btn-primary" name="print_button" id="print_button" value="Print" onclick="PrintDiv();">Print</button>
	...
	<?php require_once"print_invoice.php";?>
	</div>
...
<div id="delInvoice" class="modal fade" role="dialog">
	<div class="modal-dialog">
		...
		<div class="modal-content">
		  	<div class="modal-header">
			    <button type="button" class="close" data-dismiss="modal">&times;</button>
			    <h4 class="modal-title">Delete Recurring Invoice</h4>
		  	</div>
	  ...
	  if(document.pressed == 'save')
	  	{
	         ...
	         $.ajax({
						data:$("#myform").serialize(),
						type:"POST",
						url:'update_recurring_invoice.php',
						success: function(data)
						{
								...
								// alert('Updated Successfully !!!');
								 ...
								 swal({
									  ...
									  window.setTimeout(function()
									    { 
	 									  window.location.href= "dashboard.php?page=edit_recurring_invoice&id=<?php echo $id;?>";
	 								 	} ,1500);
...
// Recurring Invoice delete script
       ...
       { 
            var id=$('#dele_id').val();
			  e.preventDefault();
			       ...
			       $.ajax({
                            url:'delete_recurring_invoice.php',
                            type: "POST",
                            data: {
                                   id:id  
                            },
                                  ...
                                  //alert(data);
                                    if(data==1)
                                    {
                                        // alert('Deleted Successfully.');
          								// $('#dmsg').html('Product Deleted Successfully.!!!'); 
										// $('#dmsg').css('color','green');
                                        // window.location.href= "dashboard.php?page=recurring_invoices";
                                         swal({
												  position: 'top-right',
				 							      type: 'success',
