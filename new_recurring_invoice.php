...
<div class="row">
<h3>New Recurring Invoice</h3><hr>
...
<div class="col-lg-12">
	...
	<div class="col-md-2">
		<input type="date" class="form-control" name="finsh_date" id="finsh_date" >
	</div>
	<div class="col-md-3">
		<label>Maximum Number Of Occurrences:</label>
	</div>
	<div class="col-md-1">
		<input type="text" class="form-control" name="max_occur" id="max_occur" placeholder="Number">
	</div>
</div>
<div class="panel-body"></div>
...
<div class="col-lg-9">
	...
	<div class="col-md-3">
		<input type="text" class="form-control" name="txt_cleagal_id" id="txt_cleagal_id" placeholder="Client Leagal Id">
	</div>
	<div class="col-md-3">
	...
	<div class="panel-body"></div>
	<div class="col-md-6">
		<textarea class="form-control" name="txt_iaddr" id="txt_iaddr" placeholder="Invoice Address"></textarea>
	</div>
	<div class="col-md-6">
...
<div class="col-lg-12" id="pro">
	...
	<div class="col-md-1">
		<input type="text" class="form-control" name="txt_qty" id="txt_qty" placeholder="Qty" onkeyup="taxoncalculation();" value="">
		<p id="msg"></p>
	</div>
	  ...
	  if(document.pressed == 'save')
	  	{
	         ...
	         $.ajax({
						data:$("#myform").serialize(),
						type:"POST",
						url:'insert_recurring_invoice.php',
						success: function(data)
						{
							...
							if(data==1)
							{
								// alert('Save Successfully !!!');
								 // window.location.href= "logout_recurring.php";
								  swal({
									  position: 'top-right',
	 							      type: 'success',
