	...
	<div class="col-lg-12">
			...
			<table class="datatable table table-striped" id="example" cellspacing="0" width="100%">
			  ...
			  <?php 
			  	...
			  	if($utype=='admin')
			  	{
      		 		$query = mysql_query("SELECT * FROM common WHERE customer_id='$id' and `type`='Invoice'")or die(mysql_error($connection));
      		 	}
      		 	else{
      		 		$query = mysql_query("SELECT * FROM common WHERE customer_id='$sub_id' and `type`='Invoice'")or die(mysql_error($connection));
      		 	}
			   ...
			   ?>
				<tr id="invoice-23">
				  ...
				  <?php 
					...
					{
				   ?>
				  <a href="dashboard.php?page=edit_new_invoice&id=<?php echo $data['id'];?>"><?php echo $data['customer_name'];?></a>
				  <?php 
				 	 }
				 	 else
				 	 {
				   ?>
				   	<a href="user_dashboard.php?page=edit_new_invoice&id=<?php echo $data['id'];?>"><?php echo $data['customer_name'];?></a>
				   <?php } ?>
				  </td>
