	...
	<div class="col-lg-12">
			...
			<table class="datatable table table-striped" id="example" cellspacing="0" width="100%">
			  ...
			  <?php 
			  	...
			  	if($utype=='admin')
			  	{
      		 		$query = mysql_query("SELECT * FROM common WHERE customer_id='$id' and `type`='Material-Invoice'")or die(mysql_error($connection));
      		 	}
      		 	else{
      		 		$query = mysql_query("SELECT * FROM common WHERE customer_id='$sub_id' and `type`='Material-Invoice'")or die(mysql_error($connection));
      		 	}
			   ...
			   ?>
				<tr id="invoice-23">
				  ...
				  <?php 
					...
					{
				   ?>
				  <a href="dashboard.php?page=edit_mat_invoice&id=<?php echo $data['id'];?>"><?php echo $data['customer_name'];?></a>
				  <?php 
				 	 }
				 	 else
				 	 {
				   ?>
				   	<a href="user_dashboard.php?page=edit_mat_invoice&id=<?php echo $data['id'];?>"><?php echo $data['customer_name'];?></a>
				   <?php } ?>
				  </td>
...
<div class="col-lg-12" id="filter"> 
   <input type="hidden" name="us_id" id="us_id" value="<?php echo $user_id; ?>">
	...
	<div class="col-md-2">
		<input type="date" class="form-control" name="fromDate" id="fromDate" required="" placeholder="From Date">
	</div>
	...
	<div class="col-lg-12" id="reportdata">
		...
		<table class="datatable table table-striped" id="example" cellspacing="0" width="100%">
			  ...
			  <?php 
			  	...
			  	if($utype=='admin')
			  	{
			  		$query = mysql_query("SELECT * FROM common a inner join mst_supplier b on b.id=a.customer_name WHERE a.type='Material-Invoice' and a.user_id='$user_id'")or die(mysql_error($connection));
      		 	}
      		 	else{
			  		$query = mysql_query("SELECT * FROM common a inner join mst_supplier b on b.id=a.customer_name WHERE a.type='Material-Invoice'and a.user_id='$sub_id'")or die(mysql_error($connection));
      		 	}
			   ...
			   ?>
				<tr id="invoice-23">
				  ...
				  <?php 
					...
					{
				   ?>
				  <a href="dashboard.php?page=edit_mat_invoice&id=<?php echo $row['id'];?>"><?php echo $row['name'];?></a>
				  <?php 
				 	 }
				 	 else
				 	 {
				   ?>
				   	<a href="user_dashboard.php?page=edit_mat_invoice&id=<?php echo $row['id'];?>"><?php echo $row['name'];?></a>
				   <?php } ?>
