...
<div class="row">
<h3>Edit Challan&nbsp;-&nbsp;<?php echo $data['number']; ?></h3><hr>
...
<div class="col-lg-9">
	...
	<div class="col-md-6">
		...
		<div class="col-md-6">
			<input type="text" class="form-control" name="txt_state" id="txt_state" value="<?php if(isset($_GET["id"])){ echo $data['invoice_state'];} else {}?>" placeholder="State">
		</div>

		<div class="col-md-6">
			<input type="text" class="form-control" name="txt_code" id="txt_code" value="<?php if(isset($_GET["id"])){ echo $data['in_state_code'];} else {}?>" placeholder="State Code">
		</div>
